...
<div class="stats-row">
    ...
    <div class="stat-item">
        <strong>250+</strong>
        <p>Countries Covered by Search</p>
    </div>
    <div class="stat-item">
        <strong>100+</strong>
        <p>Emails Found Daily</p>
    </div>
    <div class="stat-item">
        <strong>97%</strong>
        <p>API Uptime</p>
...
<div class="section">
    ...
    <br><br>
    <!-- TABLE -->
    <div style="text-align:center;font-weight:600;padding:14px;background:var(--md-code-bg-color);border:1px solid var(--md-default-fg-color--lightest);border-bottom:none;border-radius:12px 12px 0 0;color:var(--md-default-fg-color);">Enriched Leads Table</div>
    <div class="table-wrap" style="border-top: none; border-radius: 0 0 12px 12px;">
        <table>
            <thead>
                <tr>
                    <th>Domain</th>
            ...
            <tbody>
                <tr>
                    <td class="mono">alsidras.com</td>
                    <td class="email mono">info@alsidras.com</td>
                    <td><span class="badge role">role</span></td>
                    <td><span class="badge risk">role_account</span></td>
                    <td>1</td>
                    <td class="ok">✓</td>
                </tr>
                <tr>
                    <td class="mono">alsidratechnicalservices.net</td>
                    <td class="email mono">info@alsidratechnicalservices.net</td>
                    <td><span class="badge role">role</span></td>
                    <td><span class="badge risk">role_account</span></td>
                    <td>1</td>
                    <td class="ok">✓</td>
                ...
                <tr>
                    <td class="mono">moltents.com</td>
                    <td class="email mono">info@moltents.com</td>
                    <td><span class="badge role">role</span></td>
                    <td><span class="badge risk">role_account</span></td>
                    <td>1</td>
                    <td class="ok">✓</td>
                ...
                <tr>
                    <td class="mono">sethnco.com</td>
                    <td class="email mono">info@sethnco.com</td>
                    <td><span class="badge role">role</span></td>
                    <td><span class="badge risk">role_account</span></td>
                    <td>1</td>
                    <td class="ok">✓</td>
                ...
                <tr>
                    <td class="mono">mcmaster.ae</td>
                    <td class="email mono">projects@mcmaster.ae</td>
                    <td><span class="badge role">role</span></td>
                    <td><span class="badge risk">role_account</span></td>
                    <td>1</td>
                    <td class="ok">✓</td>
